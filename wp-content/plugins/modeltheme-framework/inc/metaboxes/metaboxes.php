            ...
            'fields'     => array(
                  ...
                  */
                  ...
                  array(
                        ...
                        'id'      => 'mt_custom_header_options_status',
                        'type'    => 'select',
                        'options' => array(
                  ...
                  array(
                      ...
                      'type'    => 'radio',
                      'options' => array(
                          '1'        => '<img src="'.plugins_url().'/modeltheme-framework/inc/metaboxes/assets/headers/header_1.jpg" alt="Header v1" />',
                          '2'        => '<img src="'.plugins_url().'/modeltheme-framework/inc/metaboxes/assets/headers/header_2.jpg" alt="Header v2" />',
                          '3'        => '<img src="'.plugins_url().'/modeltheme-framework/inc/metaboxes/assets/headers/header_3.jpg" alt="Header v3" />',
                          '4'        => '<img src="'.plugins_url().'/modeltheme-framework/inc/metaboxes/assets/headers/header_4.jpg" alt="Header v4" />',
                          '5'        => '<img src="'.plugins_url().'/modeltheme-framework/inc/metaboxes/assets/headers/header_5.jpg" alt="Header v5" />',
                          '6'        => '<img src="'.plugins_url().'/modeltheme-framework/inc/metaboxes/assets/headers/header_6.jpg" alt="Header v6" />',
                          '7'        => '<img src="'.plugins_url().'/modeltheme-framework/inc/metaboxes/assets/headers/header_7.jpg" alt="Header v7" />',
                          '8'        => '<img src="'.plugins_url().'/modeltheme-framework/inc/metaboxes/assets/headers/header_8.jpg" alt="Header v8" />',
                      ),
                  ...
                  */
                  ...
                  array(
                        ...
                        'id'      => 'mt_custom_page_skin_color_status',
                        'type'    => 'select',
                        'options' => array(
                            'yes' => __( 'Yes', 'modeltheme' ),
                            'no' => __( 'No', 'modeltheme' ),
                  ...
                  */
                  ...
                  array(
                        'name'    => __( 'Enable/Disable widgetized areas before footer', 'modeltheme' ),
                        'desc'    => __( '* Enable or Disable Widgetized areas before footer.', 'modeltheme' ),
                        'id'      => 'widgetized_before_footer',
                        'type'    => 'select',
                        'options' => array(
                              'yes' => __( 'Enabled', 'modeltheme' ),
                              'no'   => __( 'Disabled', 'modeltheme' ),
                        ),
                        'default' => 'yes',
                  ),
