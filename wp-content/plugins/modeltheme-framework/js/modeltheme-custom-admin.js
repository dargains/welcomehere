...
(function ($) {
  'use strict';
	...
	jQuery( document ).ready(function() {
	    ...
	    jQuery( "#redux_demo-numbat_skin_color .redux-image-select" ).on( "click", function() {
	      
	        if (jQuery(this).attr('class') == 'redux-image-select numbat_skin_color_1 redux-image-select-selected'){
	            var bg_color = "#00ADEF";
	        ...
	        if (jQuery(this).attr('class') == 'redux-image-select numbat_skin_color_2 redux-image-select-selected'){
	            var bg_color = '#2DCC70';
	        ...
	        if (jQuery(this).attr('class') == 'redux-image-select numbat_skin_color_3 redux-image-select-selected'){
	            var bg_color = '#1BBC9B';
	        ...
	        if (jQuery(this).attr('class') == 'redux-image-select numbat_skin_color_4 redux-image-select-selected'){
	            var bg_color = '#95A5A5';
	        ...
	        if (jQuery(this).attr('class') == 'redux-image-select numbat_skin_color_5 redux-image-select-selected'){
	            var bg_color = '#E77E23';
	        ...
	        if (jQuery(this).attr('class') == 'redux-image-select numbat_skin_color_6 redux-image-select-selected'){
	            var bg_color = '#E84C3D';
	        ...
	        if (jQuery(this).attr('class') == 'redux-image-select numbat_skin_color_7 redux-image-select-selected'){
	            var bg_color = '#F1C40F';
	        ...
	        if (jQuery(this).attr('class') == 'redux-image-select numbat_skin_color_8 redux-image-select-selected'){
	            var bg_color = '#9B58B5';
